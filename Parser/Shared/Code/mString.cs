...
public static class mString
{
    ...
    public static decimal ToDecimal(this string Value)
    {
        ...
        Value = Value.ToString().ReplaceLast(new[] { '.', ',' }, System.Globalization.NumberFormatInfo.CurrentInfo.NumberDecimalSeparator);
        //if (decimal.TryParse(Value, out result))
        //{
        //    return result;
        //}
    ...
    public static string StringAndTrim(this object Value, params char[] trimChars)
    {
        if (Value == null || Value == DBNull.Value)
        {
            return "";
        }
        return Convert.ToString(Value).Trim(trimChars);
    }
